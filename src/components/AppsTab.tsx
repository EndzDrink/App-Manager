...
import { Server, Plus, ArrowLeft, ShieldAlert, CheckCircle2, Users, Filter, X, Search, Building2, Cloud, HardDrive, AlertTriangle } from 'lucide-react';
...
export const AppsTab: React.FC<AppsTabProps> = ({ apps, onAddApp }) => {
  ...
  // Ensure older data has fallback values for new fields
  ...
  // --- DATA PROCESSING: Deep Search & Filtering ---
  const processedApps = normalizedApps
    ...
    .filter(app => {
      ...
      // Deep search: checks name, category, and vendor!
  ...
  // --- DETAILED DRILL-DOWN VIEW WITH CAPABILITY OVERLAP ---
  if (selectedApp) {
    ...
    return (
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-6">
          <div className="bg-sky-50 border-b border-sky-100 px-6 py-5 flex items-center justify-between">
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Vendor & Duplication Warning Section */}
