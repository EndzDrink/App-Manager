    ...
    <>
      ...
      <footer className="shrink-0 w-full bg-white border-t border-gray-200 px-6 py-2 flex flex-col sm:flex-row items-center justify-between text-[10px] uppercase tracking-wider font-semibold text-gray-400 z-50 relative shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
        ...
        <div className="flex items-center space-x-4">
          <button onClick={() => setActiveView('about')} className="hover:text-sky-600 transition-colors">About</button>
          <button onClick={() => setActiveView('contact')} className="hover:text-sky-600 transition-colors">Contact Support</button>
          <button onClick={() => setActiveView('privacy')} className="hover:text-sky-600 transition-colors">Privacy Policy</button>
        </div>
      </footer>

      {/* ABOUT POP-UP */}
      {activeView === 'about' && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 animate-in fade-in">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden">
            <div className="px-5 py-3 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center text-gray-900 font-bold text-sm">
                <Info className="h-4 w-4 mr-2 text-sky-500" /> About the System
              </div>
      ...
      {activeView === 'contact' && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 animate-in fade-in">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden">
            <div className="px-5 py-3 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div className="flex items-center text-gray-900 font-bold text-sm">
                <Mail className="h-4 w-4 mr-2 text-sky-500" /> Technical Support
              </div>
              <button onClick={() => setActiveView('none')} className="text-gray-400 hover:text-gray-700 transition-colors"><X className="h-4 w-4" /></button>
            </div>
      ...
      {/* PRIVACY POLICY PAGE */}
      {activeView === 'privacy' && (
        <div className="fixed inset-0 bg-white z-[9999] flex flex-col animate-in slide-in-from-bottom-4 duration-300">
          
          {/* FIXED HEADER: Increased left padding (pl-24) to clear the sidebar navigation */}
          <div className="pl-24 pr-8 py-4 border-b border-gray-200 flex justify-between items-center bg-white shadow-sm shrink-0">
            <div className="flex items-center text-blue-900 font-bold text-lg">
              <ShieldCheck className="h-5 w-5 mr-2 text-sky-500 shrink-0" /> 
              <span className="truncate">Data Privacy & Governance Policy</span>
            </div>
            <Button variant="outline" onClick={() => setActiveView('none')} className="text-blue-900 hover:bg-gray-100 border-gray-200 font-bold shrink-0 ml-4">
          ...
          <div className="flex-1 overflow-y-auto p-8 lg:px-32 xl:px-64 bg-gray-50 custom-scrollbar">
            <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm space-y-6 text-sm text-gray-700 leading-relaxed">
              <div>
                <h1 className="text-2xl font-black text-blue-900 tracking-tight mb-2">Enterprise Privacy & Data Policy</h1>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Effective Date: May 2026</p>
              </div>
              
              <hr className="border-gray-100" />

              <div>
                <h3 className="text-base font-bold text-blue-900 mb-2">1. Data Ownership & Jurisdiction</h3>
              ...
              <div>
                <h3 className="text-base font-bold text-blue-900 mb-2">2. Telemetry & Monitoring</h3>
              ...
              <div>
                <h3 className="text-base font-bold text-blue-900 mb-2">3. API Connectors & Integrations</h3>
              ...
              <div>
                <h3 className="text-base font-bold text-blue-900 mb-2">4. Vendor Access</h3>
              ...
              <div className="bg-sky-50 border border-sky-200 p-4 rounded-lg text-blue-900 mt-8">
                <p className="font-black text-xs uppercase tracking-wider mb-1 text-sky-600">Legal Disclaimer</p>
                <p className="text-xs font-medium">By utilizing this software, the municipality agrees to the terms of the Master Service Agreement (MSA) established during procurement.</p>
              </div>
            </div>
