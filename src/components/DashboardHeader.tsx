...
export const DashboardHeader = () => {
  return (
    <header className="flex items-center justify-between mb-8">
      {/* AppManager Logo and Title */}
      <div className="flex items-center space-x-3">
        {/* Logo container with dark background and rounded corners */}
      ...
      {/* Action Buttons */}
      <div className="flex items-center space-x-3">
        {/* Export Button - styled for a clean, light look */}
        ...
        {/* Refresh Button - styled to match the Export button */}
        <Button variant="outline" size="sm" className="bg-white border-gray-200 text-gray-500 hover:bg-gray-50 shadow-sm transition-colors duration-200">
          <RefreshCw className="h-4 w-4 mr-2" />
          Refresh
        </Button>
        {/* Live Dashboard Button - styled with a distinct green background */}
